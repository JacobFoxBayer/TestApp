...
const CardPropTypes = {
   ...
   */
  bodyAlignment: PropTypes__default["default"].oneOf(["left-center", "left-top", "left-bottom", "centered", "right-center", "right-top", "right-bottom"]),
  /**
   ...
   * Defaults to **false**.
   */
  loadingCard: PropTypes__default["default"].bool,
  /**
   ...
   * Defaults to **'default'**.
   */
  variant: PropTypes__default["default"].oneOf(["default", "flat", "outlined", "raised"])
};
...
const CardActionButtonPropTypes = {
   ...
   * Defaults to **'primary'**.
   */
  actionButtonThemeColor: PropTypes__default["default"].oneOf(["primary", "secondary"]),
  /**
   ...
   * Defaults to **undefined**.
   */
  customRef: PropTypes__default["default"].oneOfType([PropTypes__default["default"].func,
   ...
   * Defaults to **null**.
   */
  trailingIcon: PropTypes__default["default"].oneOfType([PropTypes__default["default"].string, PropTypes__default["default"].node]),
  /**
...
const CardActionIconPropTypes = {
   ...
   */
  variant: reactCommon.deprecatedOneOf(PropTypes__default["default"].oneOf(["", "filled-danger-alt", "filled-danger", "filled-primary", "filled-secondary", "color-primary", "color-secondary", "color-on-dark"]), ["primary-alt", "secondary-alt", "primary", "danger-alt", "danger"], "CardActionIcon", "Please use one of '','filled-danger-alt','filled-danger','filled-primary','filled-secondary','color-primary','color-secondary','color-on-dark'.")
};
...
const CardActionsPropTypes = {
   ...
   * Defaults to **null**.
   */
  actionButtons: PropTypes__default["default"].node,
  /**
   * Add icons to card actions.
   *
   * Defaults to **null**.
   */
  actionIcons: PropTypes__default["default"].node,
  /**
   * Aligns action buttons and icon buttons. 'center' and 'trailing' only allow buttons.
   *
   * Defaults to **'leading'**.
   */
  alignment: PropTypes__default["default"].oneOf(["leading", "center", "trailing"])
};
...
const CardFilterPropTypes = {
   ...
   * Defaults to **'tabs'**.
   */
  filterType: PropTypes__default["default"].oneOf(["tabs", "chips", "select", "select-2"])
};
...
const CardLeadingMediaPropTypes = {
   ...
   * Defaults to **null**.
   */
  mediaUrl: PropTypes__default["default"].string,
  /**
   * Applies aspect ratio style to the card media.
   *
   * Defaults to **'square'**.
   */
  ratio: PropTypes__default["default"].oneOf(["nine-sixteen", "square", "two-one", "five-four", "four-five"])
};
...
const CardMediaPropTypes = {
   ...
   * Defaults to **'bottom'**.
   */
  contentPlacement: PropTypes__default["default"].oneOf(["bottom", "top"]),
  /**
   ...
   * Defaults to **'square'**.
   */
  ratio: PropTypes__default["default"].oneOf(["square", "sixteen-nine", "four-three", "four-five", "two-one"])
};
...
const CardTitlePropTypes = {
   ...
   * Defaults to **null**.
   */
  leadingBlock: reactCommon.requiredIfPropType(PropTypes__default["default"].node, "CardTitle", "leadingBlockType"),
  /**
   * The type of media that will render in the leading block. See README for size constraints.
   *
   * Defaults to **empty string**.
   */
  leadingBlockType: PropTypes__default["default"].oneOf(["", "avatar", "icon", "icon-with-background", "thumbnail"]),
  /**
   ...
   * Defaults to **'top'**.
   */
  placement: PropTypes__default["default"].oneOf(["top", "middle", "bottom"]),
  /**
   ...
   * Defaults to **null**.
   */
  stackedSecondaryText: PropTypes__default["default"].node,
  /**
   ...
   * Defaults to **null**.
   */
  trailingBlock: reactCommon.requiredIfPropType(PropTypes__default["default"].node, "CardTitle", "trailingBlockType"),
  /**
   * The type of media that will render in the trailing block. See README for size constraints.
   *
   * Defaults to **empty string**.
   */
  trailingBlockType: PropTypes__default["default"].oneOf(["", "title-actions", "avatar", "badge", "icon", "icon-with-background", "thumbnail"])
};
...
const Card = /*#__PURE__*/React.forwardRef((props, externalRef) => {
  const {
    bodyAlignment,
    children,
    className,
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", _extends__default["default"]({
    ref: ref,
    className: clsx__default["default"]('lmnt', 'lmnt-card', 'mdc-card', variant === 'outlined' && 'mdc-card--outlined', variant === 'flat' && 'lmnt-card--flat', variant === 'raised' && 'lmnt-card--raised', loadingCard && 'lmnt-card--loading', `lmnt-card--${bodyAlignment}`, `lmnt-theme-${themeColor}-bg`, className),
    style: styles
...
const CardActionButton = /*#__PURE__*/React.forwardRef((props, externalRef) => {
  const {
    children,
    className,
    customRef,
  ...
  return /*#__PURE__*/React__default["default"].createElement(reactButton.Button, _extends__default["default"]({
    ref: externalRef,
    customRef: customRef,
    disabled: disabled,
    fullWidth: fullWidth,
    ...
    type: type,
    variant: "text",
    className: clsx__default["default"]('mdc-card__action mdc-card__action--button', className)
  }, customProps), content);
});
...
const CardActionIcon = /*#__PURE__*/React.forwardRef((props, externalRef) => {
  const {
    active,
    ariaLabel,
    ariaLabelledBy,
  ...
  return /*#__PURE__*/React__default["default"].createElement(reactIconButton.IconButton, _extends__default["default"]({
    ...
    toggleOn: toggleOn,
    toggleOff: toggleOff,
    className: clsx__default["default"]('mdc-card__action mdc-card__action--icon', className)
...
const CardActions = /*#__PURE__*/React.forwardRef((props, externalRef) => {
  const {
    alignment,
    actionIcons,
    actionButtons,
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", _extends__default["default"]({
    ref: externalRef,
    className: clsx__default["default"]('lmnt', 'mdc-card__actions', alignment === 'leading' && 'lmnt-card__actions--leading', alignment === 'center' && 'lmnt-card__actions--center', alignment === 'trailing' && 'lmnt-card__actions--trailing', className)
  }, customProps), actionButtons && /*#__PURE__*/React__default["default"].createElement("div", {
    className: "mdc-card__action-buttons"
  }, actionButtons), actionIcons && alignment === 'leading' && /*#__PURE__*/React__default["default"].createElement("div", {
...
const CardBody = /*#__PURE__*/React.forwardRef((props, externalRef) => {
  const {
    children,
    typographyType,
    themeColor,
...
const CardContent = /*#__PURE__*/React.forwardRef((props, externalRef) => {
  const {
    children,
    className,
    ...customProps
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", _extends__default["default"]({
    ref: externalRef,
    className: clsx__default["default"](['lmnt', 'mdc-card__content'], className)
  }, customProps), children);
});
...
const CardDivider = /*#__PURE__*/React.forwardRef((props, externalRef) => {
  const {
    className,
    dividerVariant,
    dividerThemeColor,
  ...
  return /*#__PURE__*/React__default["default"].createElement(reactDivider.Divider, _extends__default["default"]({
    ...
    className: clsx__default["default"]('mdc-card__divider', 'lmnt-card-divider', className)
  }, customProps));
});
...
const CardFilter = /*#__PURE__*/React.forwardRef((props, externalRef) => {
  const {
    children,
    className,
    filterType,
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", _extends__default["default"]({
    ref: externalRef,
    className: clsx__default["default"]('lmnt', 'lmnt-card__filters', filterType === 'chips' && 'lmnt-card__filters--chips', filterType === 'select' && 'lmnt-card__filters--select', filterType === 'select-2' && 'lmnt-card__filters--select lmnt-card__filters--select-2', className)
  }, customProps), children);
});
...
const CardHorizontalGroupContext = /*#__PURE__*/React.createContext({
  groupRect: {}
});

const CardHorizontalGroup = /*#__PURE__*/React.forwardRef((props, externalRef) => {
  const {
    children,
    className,
    rtl,
  ...
  const [measureRef, rect] = reactUse.useMeasure();
  const ref = React.useRef(measureRef);
  React.useImperativeHandle(externalRef, () => ref.current, []);
  React.useImperativeHandle(measureRef, () => ref.current, []);
  return (
    /*#__PURE__*/
    // eslint-disable-next-line react/jsx-no-constructed-context-values
    React__default["default"].createElement(CardHorizontalGroupContext.Provider, {
      value: {
        groupRect: rect
      }
    }, /*#__PURE__*/React__default["default"].createElement(reactGroup.Group, _extends__default["default"]({
      className: clsx__default["default"]('lmnt-card__horizontal-group', 'lmnt-card--horizontal', className),
      ref: ref,
      gap: "none",
...
const CardOverlay = /*#__PURE__*/React.forwardRef((props, externalRef) => {
  const {
    children,
    className,
    position,
...
const CardMedia = /*#__PURE__*/React.forwardRef((props, externalRef) => {
  const {
    children,
    className,
    contentPlacement,
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", _extends__default["default"]({
    ref: externalRef,
    className: clsx__default["default"]('lmnt', 'mdc-card__media', (ratio === 'square' || !ratio) && 'mdc-card__media--square', ratio === 'sixteen-nine' && 'mdc-card__media--16-9', ratio === 'four-three' && 'lmnt-card__media--4-3', ratio === 'four-five' && 'lmnt-card__media--4-5', ratio === 'two-one' && 'lmnt-card__media--2-1', className),
    style: {
      backgroundImage: `url(${imageUrl})`,
      ...style
    }
  }, customProps), overlay && /*#__PURE__*/React__default["default"].createElement(CardOverlay, {
    overlayThemeColor: overlayThemeColor
  }), children && /*#__PURE__*/React__default["default"].createElement("div", {
    className: clsx__default["default"]('mdc-card__media-content', overlay && 'lmnt-card__media-content--with-overlay', contentPlacement === 'bottom' && 'lmnt-card__content--bottom', contentPlacement === 'top' && 'lmnt-card__content--top')
...
const CardPrimaryAction = /*#__PURE__*/React.forwardRef((props, externalRef) => {
  const {
    children,
    className,
    tag: Tag = 'div',
  ...
  return /*#__PURE__*/React__default["default"].createElement(Tag, _extends__default["default"]({
    ref: externalRef,
    tabIndex: "0",
    className: clsx__default["default"](['lmnt', 'mdc-card__primary-action'], className)
  }, customProps), children);
});
...
const CardTitle = /*#__PURE__*/React.forwardRef((props, externalRef) => {
  const {
    className,
    leadingBlock,
    leadingBlockType,
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", _extends__default["default"]({
    ref: externalRef,
    className: clsx__default["default"]('lmnt', 'lmnt-card-title', stacked && 'lmnt-card-title--stacked', placement === 'top' && 'lmnt-card-title--top-placement', placement === 'bottom' && 'lmnt-card-title--bottom-placement', themeColor === 'primary' && 'lmnt-theme-primary-bg', themeColor === 'secondary' && 'lmnt-theme-secondary-bg', className)
  }, customProps), leadingBlockType ? /*#__PURE__*/React__default["default"].createElement("div", {
    className: clsx__default["default"]('lmnt-card-title__leadingBlock', leadingBlockType === 'avatar' && 'lmnt-card-title__leadingBlock--avatar', leadingBlockType === 'icon' && 'lmnt-card-title__leadingBlock--icon', leadingBlockType === 'icon-with-background' && 'lmnt-card-title__leadingBlock--icon-with-background', leadingBlockType === 'thumbnail' && 'lmnt-card-title__leadingBlock--thumbnail')
  }, leadingBlock) : null, /*#__PURE__*/React__default["default"].createElement("div", {
    className: "lmnt-card-title__text"
  }, overlineText && /*#__PURE__*/React__default["default"].createElement("div", {
    className: "lmnt-card-title__overlineText"
  }, overlineText), primaryText, (secondaryText || stackedSecondaryText) && /*#__PURE__*/React__default["default"].createElement("div", {
    className: clsx__default["default"]('lmnt-card-title-secondaryText-container', !stacked && 'lmnt-card-title__items')
  }, secondaryText && /*#__PURE__*/React__default["default"].createElement("div", {
    className: "lmnt-card-title__secondaryText"
  }, secondaryText), stackedSecondaryText && /*#__PURE__*/React__default["default"].createElement("div", {
    className: "lmnt-card-title__secondaryText"
  }, stackedSecondaryText))), trailingBlockType ? /*#__PURE__*/React__default["default"].createElement("div", {
    className: clsx__default["default"]('lmnt-card-title__trailingBlock', trailingBlockType === 'title-actions' && 'lmnt-card-title__trailingBlock--title-actions', trailingBlockType === 'avatar' && 'lmnt-card-title__trailingBlock--avatar', trailingBlockType === 'icon' && 'lmnt-card-title__trailingBlock--icon', trailingBlockType === 'icon-with-background' && 'lmnt-card-title__trailingBlock--icon-with-background', trailingBlockType === 'thumbnail' && 'lmnt-card-title__trailingBlock--thumbnail', trailingBlockType === 'badge' && 'lmnt-card-title__trailingBlock--badge')
  }, trailingBlock) : null);
});
...
const CardLeadingMedia = /*#__PURE__*/React.forwardRef((props, externalRef) => {
  const {
    style,
    children,
    mediaUrl,
  ...
  } = React.useContext(CardHorizontalGroupContext);
  React.useEffect(() => {
    if (!height) {
      return;
    }
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", _extends__default["default"]({
    className: clsx__default["default"]('lmnt', 'mdc-card__media', 'lmnt-card__leading-media', className),
    ref: ref,
    style: {
...
exports.CardHorizontalGroup = CardHorizontalGroup;
exports.CardLeadingMedia = CardLeadingMedia;
