...
var linearProgress = require('@material/linear-progress');
...
const LinearProgressPropTypes = {
   ...
   * Defaults to **1**.
   */
  buffer: PropTypes__default["default"].number,
  /**
   ...
   * Defaults to **undefined**.
   */
  indeterminate: reactCommon.deprecatedProp(PropTypes__default["default"].bool, "LinearProgress", 'Use `variant="indeterminate"` instead.'),
  /**
   ...
   * Defaults to **false**.
   */
  reversed: PropTypes__default["default"].bool,
  /**
   * Color of the indicator stroke with 'primary' or 'secondary' theme color.
   *
   * Defaults to **'primary'**.
   */
  themeColor: PropTypes__default["default"].oneOf(["primary", "secondary", "primary-variant", "secondary-variant"]),
  /**
...
const LinearProgress = /*#__PURE__*/React.forwardRef((props, externalRef) => {
  const {
    ariaLabel,
    buffer,
    className,
  ...
  const mdcLinearProgress = React.useRef();
  React.useImperativeHandle(externalRef, () => rootRef.current, []);
  React.useEffect(() => {
    mdcLinearProgress.current = new linearProgress.MDCLinearProgress(rootRef.current);
    return () => {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", _extends__default["default"]({
    ...
    className: clsx__default["default"](className, 'lmnt', 'mdc-linear-progress', !open && 'mdc-linear-progress--closed', indeterminate || variant === 'indeterminate' && 'mdc-linear-progress--indeterminate', themeColor === 'primary' && 'lmnt-linear-progress--primary', themeColor === 'primary-variant' && 'lmnt-linear-progress--primary-variant', themeColor === 'secondary' && 'lmnt-linear-progress--secondary', themeColor === 'secondary-variant' && 'lmnt-linear-progress--secondary-variant')
