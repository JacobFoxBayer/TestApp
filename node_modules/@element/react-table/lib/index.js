...
var reactDatepicker = require('@element/react-datepicker');
var reactTable = require('react-table');
var reactWindow = require('react-window');
var sortable = require('@dnd-kit/sortable');
var utilities = require('@dnd-kit/utilities');
var core = require('@dnd-kit/core');
var reactPagination = require('@element/react-pagination');
...
const TablePropTypes = {
   ...
   * Defaults to **false**.
   */
  alwaysUseDivTags: PropTypes__default["default"].bool,
  /**
   ...
   * Defaults to **false**.
   */
  canUnSort: PropTypes__default["default"].bool,
  /**
   ...
   */
  cellProps: PropTypes__default["default"].oneOfType([PropTypes__default["default"].object, PropTypes__default["default"].func]),
  /**
   ...
   * Defaults to **false**.
   */
  columnReordering: PropTypes__default["default"].bool,
  /**
   * Apply a striped effect to columns.
   *
   * Defaults to **false**.
   */
  columnStriped: PropTypes__default["default"].bool,
  /**
   ...
   * Defaults to **[]**.
   */
  columns: PropTypes__default["default"].arrayOf(PropTypes__default["default"].object),
  /**
   ...
   * Defaults to **null**.
   */
  defaultColumn: PropTypes__default["default"].object,
  /**
   ...
   * Defaults to **false**.
   */
  disableMultiSort: PropTypes__default["default"].bool,
  /**
   ...
   * Defaults to **undefined**.
   */
  expandedRowTemplate: PropTypes__default["default"].func,
  /**
   ...
   * Defaults to **true**.
   */
  fixedColumnsBorder: PropTypes__default["default"].bool,
  /**
   ...
   * Defaults to **undefined**.
   */
  headerCellProps: PropTypes__default["default"].oneOfType([PropTypes__default["default"].object, PropTypes__default["default"].func]),
  /**
   ...
   * Defaults to **null**.
   */
  headerContent: PropTypes__default["default"].node,
  /**
   ...
   * Defaults to **false**.
   */
  headerDividerTall: PropTypes__default["default"].bool,
  /**
   * Add a splash of color to the divider between the header and rows.
   *
   * Defaults to **null**.
   */
  headerDividerThemeColor: PropTypes__default["default"].oneOf(["", "primary", "secondary", "primary-variant", "secondary-variant"]),
  /**
   ...
   * Defaults to **undefined**.
   */
  headerRowProps: PropTypes__default["default"].oneOfType([PropTypes__default["default"].object, PropTypes__default["default"].func]),
  /**
   ...
   * Defaults to **null**.
   */
  headerThemeColor: PropTypes__default["default"].oneOf(["", "neutral", "primary", "secondary", "primary-variant", "secondary-variant"]),
  /**
   ...
   * Defaults to **false**.
   */
  hideHorizontalScrollbar: PropTypes__default["default"].bool,
  /**
   * All expandable/collapsible rows will be expanded when used with `expandable`.
   *
   * Defaults to **undefined**.
   */
  initiallyExpanded: PropTypes__default["default"].bool,
  /**
   ...
   * Defaults to **'block'**.
   */
  layout: PropTypes__default["default"].oneOf(["standard", "block", "flex"]),
  /**
   * Custom content to appear inside the table container directly above the actual table.
   *
   * Defaults to **null**.
   */
  leadingContent: PropTypes__default["default"].node,
  /**
   ...
   * Defaults to **false**.
   */
  noContentIncludeTable: PropTypes__default["default"].bool,
  /**
   * The message to show when there is no table content or data.
   *
   * Defaults to **'There is no content available.'**.
   */
  noContentMessage: PropTypes__default["default"].oneOfType([PropTypes__default["default"].string, PropTypes__default["default"].func, PropTypes__default["default"].node]),
  /**
   ...
   * Defaults to **null**.
   */
  plugins: PropTypes__default["default"].arrayOf(PropTypes__default["default"].object),
  /**
   * Enable columns to be resized by the user.
   *
   * Defaults to **null**.
   */
  resizableColumns: PropTypes__default["default"].bool,
  /**
   ...
   * Defaults to **undefined**.
   */
  rowProps: PropTypes__default["default"].oneOfType([PropTypes__default["default"].object, PropTypes__default["default"].func]),
  /**
   * Apply a stripped effect to the rows.
   *
   * Defaults to **null**.
   */
  rowStriped: PropTypes__default["default"].bool,
  /**
   * Enable the sort indicator to be hidden until the header cell is hovered/activated.
   *
   * Defaults to **false**.
   */
  sortIndicatorOnHover: PropTypes__default["default"].bool,
  /**
...
const TableCellPropTypes = {
   ...
   * Defaults to **undefined**.
   */
  backgroundColor: reactCommon.deprecatedProp(PropTypes__default["default"].string, "TableCell", "This prop has been deprecated in favor of `cellProps` in the column schema (see README), which offers more flexibility."),
  /**
   ...
   * Defaults to **null**.
   */
  customRenderer: PropTypes__default["default"].func,
  /**
   ...
   * Defaults to **false**.
   */
  nestable: PropTypes__default["default"].bool,
  /**
...
const TableHeaderCellPropTypes = {
   ...
   * Defaults to **null**.
   */
  actionsRenderer: PropTypes__default["default"].func,
  /**
   * The table will always use div tags instead of standard table tags. Note, disabled when using `layout='standard'`.
   *
   * Defaults to **false**.
   ...
   * Defaults to **undefined**.
   */
  backgroundColor: reactCommon.deprecatedProp(PropTypes__default["default"].string, "TableHeaderCell", "This prop has been deprecated in favor of `cellProps` in the column schema (see README), which offers more flexibility."),
  /**
   * Mostly commonly a string, accepts any valid markup.
   *
   * Defaults to **null**.
...
const TableNoContentPropTypes = {
   ...
   * Defaults to **false**.
   */
  includeTableMarkup: PropTypes__default["default"].bool
};
...
const TableTopBarPropTypes = {
   ...
   * Defaults to **null**.
   */
  filterBar: PropTypes__default["default"].node,
  /**
   ...
   * Defaults to **undefined**.
   */
  prominent: reactCommon.deprecatedProp(PropTypes__default["default"].bool, "TableTopBar", "May be removed pending further review."),
  /**
...
const TableNoContent = /*#__PURE__*/React.forwardRef((props, externalRef) => {
  const {
    children,
    className,
    includeTableMarkup,
  ...
  const content = /*#__PURE__*/React__default["default"].createElement("div", _extends__default["default"]({
    ref: externalRef,
    className: clsx__default["default"]('lmnt-table__no-content', className)
  }, customProps), children);
  return includeTableMarkup ? /*#__PURE__*/React__default["default"].createElement("tr", null, /*#__PURE__*/React__default["default"].createElement("td", null, content)) : content;
});
...
const TableBase = /*#__PURE__*/React.forwardRef((props, externalRef) => {
  const {
    alwaysUseDivTags,
    fixedColumns,
    ariaLabel,
  ...
  const mdcDataTable = React.useRef();
  const tableRef = React.useRef();
  const hasContent = !!children;
  React.useImperativeHandle(externalRef, () => tableRef.current, []);
  React.useEffect(() => {
    if (hasContent && !noInit && !virtualized && !alwaysUseDivTags && !mdcDataTable.current) {
      try {
        mdcDataTable.current = dataTable.MDCDataTable.attachTo(tableRef.current);
      } catch (e) {
        shared.edsWarning(`Error rendering table: "${e.message}". This most likely means that the table contents were empty`);
      }
    }
    return () => {
  ...
  const content = React.useMemo(() => hasContent ? children : /*#__PURE__*/React__default["default"].createElement(TableNoContent, null, noContentMessage), [children, noContentMessage, hasContent]);
  const TableTag = alwaysUseDivTags ? 'div' : 'table';
  return /*#__PURE__*/React__default["default"].createElement("div", _extends__default["default"]({
    className: classes,
    ref: tableRef,
    style: styles
  }, customProps), leadingContent, /*#__PURE__*/React__default["default"].createElement("div", _extends__default["default"]({
    className: clsx__default["default"]('mdc-data-table__table-container', 'lmnt-data-table__container'
    // (fullWidth || layout === 'flex') &&
    //     'lmnt-data-table--flex-overflow'
    )
  }, containerProps), /*#__PURE__*/React__default["default"].createElement(TableTag, {
    className: clsx__default["default"]('mdc-data-table__table', 'lmnt-table__table', fixedHeader && layout === 'block' && 'lmnt-table__block-fixed-header', fixedHeader && layout === 'flex' && 'lmnt-table__flex-fixed-header'),
...
const formatCellValue = props => {
  ...
  switch (displayTypeActual) {
    ...
    case 'switch':
      return /*#__PURE__*/React__default["default"].createElement(reactSwitch.Switch, {
        dense: true,
        checked: value,
        onChange: onCellUpdate(accessor, rowId)
      });
...
const formatCellEditor = props => {
  ...
  switch (editType) {
    case 'checkbox':
      return /*#__PURE__*/React__default["default"].createElement(reactCheckbox.Checkbox, _extends__default["default"]({
        checked: valueActual
      }, sharedProps));
    case 'switch':
      return /*#__PURE__*/React__default["default"].createElement(reactSwitch.Switch, _extends__default["default"]({
        checked: valueActual
      }, sharedProps));
    case 'datepicker':
      return /*#__PURE__*/React__default["default"].createElement(reactDatepicker.Datepicker, _extends__default["default"]({
        variant: variant,
        value: valueActual
      }, sharedProps));
    case 'number':
...
const formatColumns = (columns, onCellUpdate) => {
  ...
  return columns.map(column => {
    ...
    const temp = {
      ...
      id: column.id || reactCommon.edsRandomId()
    };
...
const getInitialState = columns => {
  const sorting = sortBy__default["default"](columns.reduce((out, c, i) => {
    if (c.defaultSort) {
      out.push({
        id: c.id,
...
const ReactTableManager = props => {
  ...
  const plugins = React.useMemo(() => {
    const list = [];
    if (sortable) list.push(reactTable.useSortBy);
    if (paginated === true || paginated === 'standard') list.push(reactTable.usePagination);
    if (layout === 'block') list.push(reactTable.useBlockLayout);
    ...
    if (!layout && (resizableColumns || virtualized || columnReordering)) {
      list.push(reactTable.useBlockLayout);
    }
    if (resizableColumns) list.push(reactTable.useResizeColumns);
    if (layout === 'flex') list.push(reactTable.useFlexLayout);
    if (layout === 'absolute') list.push(reactTable.useAbsoluteLayout);
    if (expandable) list.push(reactTable.useExpanded);
    return list;
  }, [columnReordering, expandable, layout, paginated, resizableColumns, sortable, virtualized]);
  const tableProps = reactTable.useTable({
    columns,
    data,
    // TODO: this is broken in the current version (and never fully worked). I intend to fix it sometime in the future, so I'm leaving this zombie code for now.
    // defaultColumn,
...
const TableBody = /*#__PURE__*/React.forwardRef((props, externalRef) => {
  const {
    alwaysUseDivTags,
    children,
    className,
  ...
  return /*#__PURE__*/React__default["default"].createElement(Tag, _extends__default["default"]({
    ref: externalRef,
    className: clsx__default["default"]('mdc-data-table__content lmnt-table__body', className)
  }, customProps, {
    style: styles
  }), children);
});
...
const TableCell = /*#__PURE__*/React.forwardRef((props, externalRef) => {
  const {
    alwaysUseDivTags,
    backgroundColor,
    cell,
  ...
  const [idActual] = React.useState(id || (cell === null || cell === void 0 ? void 0 : cell.id) || reactCommon.edsRandomId());
  ...
  const cellProps = {
    className: clsx__default["default"]('lmnt', 'mdc-data-table__cell', isTrailingFixed && 'lmnt-table__trailing-fixed-cell', isLeadingFixed && 'lmnt-table__leading-fixed-cell', fixedColumnsBorder && 'lmnt-table__leading-fixed-cell--trailing-border', nestable && 'lmnt-table__cell--nestable', className),
    ref,
    id: idActual,
    role: 'gridcell',
    style: styles,
  ...
  return /*#__PURE__*/React__default["default"].createElement(Tag, cellProps, /*#__PURE__*/React__default["default"].createElement("div", {
  ...
  }, /*#__PURE__*/React__default["default"].createElement(CellRenderer, {
    cell: cell
  }, children))));
});
...
const TableRow = /*#__PURE__*/React.forwardRef((props, externalRef) => {
  const {
    alwaysUseDivTags,
    children,
    className,
  ...
  return /*#__PURE__*/React__default["default"].createElement(Tag, _extends__default["default"]({
    ref: externalRef,
    className: clsx__default["default"]('lmnt', 'mdc-data-table__row', 'lmnt-table__row', className),
    role: "row",
    style: rowStyle
  }, customProps), children);
});
...
var renderRows = (_ref => {
  ...
  return _ref2 => {
    ...
    }, /*#__PURE__*/React__default["default"].createElement(TableRow, combinedProps, row.cells.map((cell, columnIndex) => {
      const customCellProps = createProps(cellProps, cell.column.cellProps, [cell]);
      return /*#__PURE__*/React__default["default"].createElement(TableCell, _extends__default["default"]({
        layout: layout,
    ...
    })), showExpandedContent && /*#__PURE__*/React__default["default"].createElement(TableRow, {
...
const TableRowVirtualRenderer = _ref => {
  ...
  const VirtualList = variableHeight ? reactWindow.VariableSizeList : reactWindow.FixedSizeList;
  return /*#__PURE__*/React__default["default"].createElement(VirtualList, {
    height: height,
    itemCount: rowCount,
    itemSize: rowHeight,
...
var TableBodyRenderer = (_ref => {
  ...
  return /*#__PURE__*/React__default["default"].createElement(TableBody, _extends__default["default"]({
    alwaysUseDivTags: alwaysUseDivTags
  }, getTableBodyProps === null || getTableBodyProps === void 0 ? void 0 : getTableBodyProps()), showNoContent && /*#__PURE__*/React__default["default"].createElement(TableRow, null, /*#__PURE__*/React__default["default"].createElement(TableCell, {
    colSpan: columns === null || columns === void 0 ? void 0 : columns.length
  }, /*#__PURE__*/React__default["default"].createElement(TableNoContent, null, noContentMessage))), /*#__PURE__*/React__default["default"].createElement(VirtualList, {
    rowHeight: rowHeight,
...
const TableHeader = /*#__PURE__*/React.forwardRef((props, externalRef) => {
  const {
    alwaysUseDivTags,
    children,
    className,
  ...
  return /*#__PURE__*/React__default["default"].createElement(Tag, _extends__default["default"]({
    ref: externalRef,
    className: clsx__default["default"]('lmnt', 'lmnt-table__header', className)
  }, customProps, {
    style: style
  }), children);
});
...
const TableHeaderRow = /*#__PURE__*/React.forwardRef((props, externalRef) => {
  const {
    alwaysUseDivTags,
    children,
    className,
  ...
  return /*#__PURE__*/React__default["default"].createElement(Tag, _extends__default["default"]({
    ref: externalRef,
    className: clsx__default["default"]('lmnt', 'mdc-data-table__header-row lmnt-table__header-row', className)
  }, customProps), children);
});
...
const TableVerticalResizeHandle = /*#__PURE__*/React.forwardRef((props, externalRef) => {
  const {
    column,
    children,
    className,
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", _extends__default["default"]({
    ref: externalRef,
    className: clsx__default["default"]('lmnt', 'lmnt-table__resize-handle', className)
...
/* eslint-disable react/prop-types */
const TableSortIndicator = /*#__PURE__*/React.forwardRef((props, externalRef) => {
  const {
    column,
    id,
  ...
  return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement("button", {
    ref: externalRef,
    type: "button",
    className: clsx__default["default"]('lmnt', 'mdc-icon-button material-icons mdc-data-table__sort-icon-button', isSorted && !sortIndicatorOnHover && 'lmnt-table__sort-icon-button--visible')

    // aria-label='Sort by dessert'
    // aria-describedby='dessert-status-label'
  }, isSortedDesc ? 'arrow_downward' : 'arrow_upward'), /*#__PURE__*/React__default["default"].createElement("div", {
...
const TableHeaderCell = /*#__PURE__*/React.forwardRef((props, customUserRef) => {
  const {
    actionsRenderer,
    alwaysUseDivTags,
    backgroundColor,
  ...
  const ref = React.useRef(columnSortingRef || customUserRef);
  const [fixedOffset, setFixedOffset] = React.useState(isLeadingFixed && layout !== 'standard' && column ? column.totalLeft : null);
  const [fixedWidth, setFixedWidth] = React.useState();
  React.useEffect(() => {
  ...
  const Content = React.useMemo(() => () => {
    const content = column ? /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, column.header ? column.render('header') : column.render('Header'), children) : children;
    return customRenderer && customRenderer(content) || content;
  }, [column, customRenderer, children]);
  const Actions = React.useMemo(() => () => {
    const actions = /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, (sortable || (column === null || column === void 0 ? void 0 : column.sortable)) && /*#__PURE__*/React__default["default"].createElement(TableSortIndicator, {
      sortIndicatorOnHover: sortIndicatorOnHover,
      column: column
    }), resizableColumns && /*#__PURE__*/React__default["default"].createElement(TableVerticalResizeHandle, {
      column: column
    }));
  ...
  const handleColumnClick = React.useCallback(event => {
    var _column$onClick;
  ...
  return /*#__PURE__*/React__default["default"].createElement(Tag, _extends__default["default"]({
    className: clsx__default["default"]('lmnt', 'mdc-data-table__header-cell', 'lmnt-table__header-cell', isTrailingFixed && 'lmnt-table__trailing-fixed-cell', isLeadingFixed && 'lmnt-table__leading-fixed-cell', fixedColumnsBorder && 'lmnt-table__leading-fixed-cell--trailing-border', isDragging && 'lmnt-table__header-cell--dragging', isSorting && 'lmnt-table__header-cell--sorting', className),
    ref: ref,
    id: id || (column === null || column === void 0 ? void 0 : column.id),
    role: "columnheader",
    scope: "col",
    onClick: handleColumnClick
  }, finalProps), /*#__PURE__*/React__default["default"].createElement("div", {
    className: "lmnt-table__cell-content",
    style: getColumnAlignment(column)
  }, /*#__PURE__*/React__default["default"].createElement(Content, null), /*#__PURE__*/React__default["default"].createElement(Actions, null)));
});
...
const ColumnDndSorter = props => {
  ...
  const sensors = core.useSensors(core.useSensor(core.PointerSensor), core.useSensor(core.MouseSensor), core.useSensor(core.KeyboardSensor, {
  ...
  return /*#__PURE__*/React__default["default"].createElement(core.DndContext, {
    sensors: sensors,
...
const SpecialContextContainer = props => {
  ...
  _ref => {
    ...
    return columnReordering ? /*#__PURE__*/React__default["default"].createElement(ColumnDndSorter, {
      onUpdate: onColumnSort,
      itemIds: headerGroup.headers.map(h => h.id)
    }, children) : children;
  }, [children]);
  return columnSorting && /*#__PURE__*/React__default["default"].createElement(ColumnSortContext, columnSorting);
};
...
var TableHeaderRenderer = (_ref => {
  ...
  return /*#__PURE__*/React__default["default"].createElement(TableHeader, {
    ...
    return /*#__PURE__*/React__default["default"].createElement(SpecialContextContainer, {
    ...
    }, /*#__PURE__*/React__default["default"].createElement(TableHeaderRow, headerGroup.getHeaderGroupProps({
      ...
      return /*#__PURE__*/React__default["default"].createElement(TableHeaderCell, _extends__default["default"]({
        sortIndicatorOnHover: sortIndicatorOnHover,
        layout: layout
...
var PaginationRenderer = (_ref => {
  ...
  return paginated && /*#__PURE__*/React__default["default"].createElement(reactPagination.Pagination, {
    controlled: true,
    disabled: disabled,
...
const TableBuilder = /*#__PURE__*/React.forwardRef((props, externalRef) => {
  const {
  ...
  const tableRef = React.useRef();
  const hasFixedColumns = React.useMemo(() => columns.some(x => x.fixed), [columns]);
  const formattedColumns = React.useMemo(() => formatColumns(columns, handleCellUpdate(onCellUpdate)),
  // eslint-disable-next-line react-hooks/exhaustive-deps
  [columns, onCellUpdate]);
  const [sortedColumns, setSortedColumns] = React.useState(formattedColumns);
  ...
  React.useEffect(() => {
    if (virtualized && !height) reactCommon.edsWarning('Element Table: Height must be defined when using `virtualized`. A default height of 500 has been set.');
  }, [virtualized, height]);
  React.useEffect(() => {
  ...
  return /*#__PURE__*/React__default["default"].createElement(TableBase, _extends__default["default"]({}, tableProps, {
    ref: tableRef,
    noInit: true,
    alwaysUseDivTags: alwaysUseDivTagsActual,
    fixedColumns: hasFixedColumns,
    trailingContent: /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(PaginationRenderer, {
      tableProps: props,
      rtProps: rtProps
    }), trailingContent)
  }), headerContent, /*#__PURE__*/React__default["default"].createElement(TableHeaderRenderer, {
    tableProps: props,
    alwaysUseDivTags: alwaysUseDivTagsActual,
    rtProps: rtProps,
    canReorderColumns: canReorderColumns,
    setSortedColumns: setSortedColumns
  }), /*#__PURE__*/React__default["default"].createElement(TableBodyRenderer, {
    alwaysUseDivTags: alwaysUseDivTagsActual,
    rowHeight: rowHeight,
    variableHeight: variableHeight,
    tableProps: props,
...
const Table = /*#__PURE__*/React.forwardRef((props, externalRef) => {
  const {
    alwaysUseDivTags,
    ariaLabel,
    canUnSort,
  ...
  const fixedOffsetsState = React.useState([]);
  const fixedWidthsState = React.useState([]);
  const hasData = (data === null || data === void 0 ? void 0 : data.length) > 0 && (columns === null || columns === void 0 ? void 0 : columns.length) > 0;
  if (!hasData && !children && !noContentIncludeTable) return /*#__PURE__*/React__default["default"].createElement(TableNoContent, {
    ref: externalRef
  }, noContentMessage);
  const commonProps = {
    ariaLabel,
  ...
  if (!data && children) return /*#__PURE__*/React__default["default"].createElement(TableContext.Provider, {
  ...
  }, /*#__PURE__*/React__default["default"].createElement(reactCommon.HoistingContext.Provider, {
    value: reactCommon.hoistingEnabled
  }, /*#__PURE__*/React__default["default"].createElement(TableBase, _extends__default["default"]({
    layout: "standard",
    ref: externalRef,
  ...
  }, /*#__PURE__*/React__default["default"].createElement(TableBuilder, _extends__default["default"]({
    ref: externalRef
  }, props)));
});
...
const TableFooter = /*#__PURE__*/React.forwardRef((props, externalRef) => {
  const {
    children,
    className,
    alwaysUseDivTags,
  ...
  return /*#__PURE__*/React__default["default"].createElement(Tag, _extends__default["default"]({
    ref: externalRef,
    className: clsx__default["default"]('lmnt', 'lmnt-table__footer', className)
  }, customProps, {
    style: style
  }), children);
});
...
const TableTopBar = /*#__PURE__*/React.forwardRef((props, externalRef) => {
  const {
    title,
    actions,
    prominent,
  ...
  return /*#__PURE__*/React__default["default"].createElement("header", _extends__default["default"]({
    ref: externalRef,
    className: clsx__default["default"]('lmnt-table__top-bar', prominent && 'lmnt-table__top-bar--prominent', className)
  }, customProps), /*#__PURE__*/React__default["default"].createElement("section", {
    className: "lmnt-table__top-bar--standard-bar"
  }, /*#__PURE__*/React__default["default"].createElement("div", {
    className: "lmnt-table__top-bar__title"
  }, /*#__PURE__*/React__default["default"].createElement(reactTypography.TypoDisplay, {
    level: 6
  }, title)), actions ? /*#__PURE__*/React__default["default"].createElement("div", {
...
exports.TableNoContent = TableNoContent;
exports.TableRow = TableRow;
exports.TableSortIndicator = TableSortIndicator;
exports.TableTopBar = TableTopBar;
exports.TableVerticalResizeHandle = TableVerticalResizeHandle;
