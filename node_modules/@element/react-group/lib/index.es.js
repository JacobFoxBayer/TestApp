...
const GroupPropTypes = {
   ...
   */
  gap: PropTypes.oneOf(["dense", "standard", "airy", "none"]),
  /**
   ...
   */
  padding: deprecatedProp(PropTypes.oneOf(["dense", "standard", "airy", "none"]), "Group", "Renamed for improved clarity. See `gap`."),
  /**
   ...
   * Defaults to **'start'**.
   */
  primaryAlign: PropTypes.oneOf(["start", "end", "center", "space-evenly", "space-between", "space-around"]),
  /**
   ...
   */
  secondaryAlign: PropTypes.oneOf(["start", "end", "center", "stretch", "baseline"])
};
...
const Group = /*#__PURE__*/forwardRef((props, externalRef) => {
  const {
    children,
    className,
    direction,
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    ref: ref,
    className: clsx('lmnt', 'lmnt-group',
