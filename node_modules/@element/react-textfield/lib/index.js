...
var reactLineRipple = require('@element/react-line-ripple');
...
const TextfieldSpanShim = /*#__PURE__*/React.forwardRef((props, externalRef) => {
  const {
    wrap,
    children
  } = props;
  return wrap ? /*#__PURE__*/React__default["default"].createElement("span", {
    ref: externalRef,
...
const TextfieldPropTypes = {
   ...
   */
  block: reactCommon.deprecatedProp(PropTypes__default["default"].bool, "Textfield", "Use `fullWidth` instead."),
  /**
   ...
   * Defaults to **undefined**.
   */
  containerClass: reactCommon.deprecatedProp(PropTypes__default["default"].string, "Textfield", "See `containerProps`."),
  /**
   ...
   * Defaults to **undefined**.
   */
  embedded: reactCommon.deprecatedProp(PropTypes__default["default"].bool, "Textfield", 'Use `variant="embedded"'),
  /**
   ...
   * Defaults to **undefined**.
   */
  filled: reactCommon.deprecatedProp(PropTypes__default["default"].bool, "Textfield", 'Use variant="filled" instead.'),
  /**
   ...
   * Defaults to **undefined**.
   */
  maxLength: reactCommon.deprecatedProp(PropTypes__default["default"].number, "Textfield", "Use `maxlength` instead. The case of this prop has changed to be more consistent."),
  /**
   * Restricts the number of characters that can be entered, best used with counter.
   *
   * Defaults to **null**.
   */
  maxlength: reactCommon.requiredIfPropType(PropTypes__default["default"].number, "Textfield", "counter"),
  /**
   * Prevents resizing when using `textarea`.
   *
   * Defaults to **true**.
   */
  noResize: PropTypes__default["default"].bool,
  /**
   ...
   * Defaults to **undefined**.
   */
  outlined: reactCommon.deprecatedProp(PropTypes__default["default"].bool, "Textfield", 'Use `variant="outlined"` instead'),
  /**
   ...
   * Defaults to **null**.
   */
  prefixText: PropTypes__default["default"].string,
  /**
   ...
   * Defaults to **undefined**.
   */
  primary: reactCommon.deprecatedProp(PropTypes__default["default"].bool, "Textfield", 'This feature is no longer supported. Use `variant="filled"` instead.'),
  /**
   * @deprecated _Use `variant='embedded'`_
   *
   ...
   * Defaults to **undefined**.
   */
  search: reactCommon.deprecatedProp(PropTypes__default["default"].bool, "Textfield", 'Use `variant="embedded"`'),
  /**
   ...
   * Defaults to **undefined**.
   */
  secondary: reactCommon.deprecatedProp(PropTypes__default["default"].bool, "Textfield", 'Use `variant="outlined"` instead.'),
  /**
   ...
   * Defaults to **null**.
   */
  suffixText: PropTypes__default["default"].string,
  /**
   ...
   * Defaults to **null**.
   */
  tooltip: PropTypes__default["default"].oneOfType([PropTypes__default["default"].bool, PropTypes__default["default"].object]),
  /**
   ...
   * Defaults to **'text'**.
   */
  type: PropTypes__default["default"].oneOf(["text", "password", "color", "email", "url", "number", "tel", "search", "datetime-local", "month", "time", "week", "date"]),
  /**
   ...
   * Defaults to **'filled'**.
   */
  variant: PropTypes__default["default"].oneOf(["filled", "outlined", "embedded"])
};
...
const LeadingIcon = leadingIcon => {
  ...
  return reactCommon.addProps(leadingIcon, {
    className: clsx__default["default"]('mdc-text-field__icon lmnt-text-field__icon mdc-text-field__icon--leading', displayName === 'IconButton' && 'lmnt-text-field__icon-button--leading'),
...
const TrailingIcon = trailingIcon => {
  ...
  return reactCommon.addProps(trailingIcon, {
    className: clsx__default["default"]('mdc-text-field__icon lmnt-text-field__icon mdc-text-field__icon--trailing', displayName === 'IconButton' && 'lmnt-text-field__icon-button--trailing'),
    dense: displayName === 'IconButton' ? true : undefined,
    role: displayName === 'IconButton' ? 'button' : null
  });
};
const Textfield = /*#__PURE__*/React.forwardRef((props, externalRef) => {
  const {
    block,
    className,
    containerClass,
  ...
  const [helperTextIdActual] = React.useState(() => helperTextId || shared.edsRandomId());
  const [labelIdActual] = React.useState(() => labelId || shared.edsRandomId());
  const [isBlockElement, setIsBlockElement] = React.useState(true);
  const [hasCounter, setHasCounter] = React.useState(false);
  const [currentMaxlength, setCurrentMaxlength] = React.useState(maxlength);
  ...
  const mdcTextFieldRef = React.useRef();
  const labelRef = React.useRef();
  const inputRefActual = React.useRef();
  const containerRef = React.useRef();
  const tooltipRef = React.useRef();
  const popperRef = React.useRef();
  const hasIcon = (trailingIcon || leadingIcon) && !textarea;
  const isValid = React.useMemo(() => valid === undefined || valid === null ? true : valid, [valid]);
  ...
  React.useEffect(() => {
    mdcTextFieldRef.current = textfield.MDCTextField.attachTo(labelRef.current);
    return () => {
  ...
  React.useEffect(() => {
    ...
    if (helperText && typeof helperText === 'string') {
      helperTextRef.current = new textfield.MDCTextFieldHelperText(helperTextDomRef.current);
    }
    return () => {
  ...
  React.useEffect(() => {
    if (tooltip) {
      ...
      popperRef.current = core.createPopper(ref.current, tooltipRef.current, {
        placement: position,
        modifiers
      });
    }
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", _extends__default["default"]({
    ...
    className: clsx__default["default"]('mdc-text-field__input', type === 'color' && 'lmnt-text-field__input--color'),
    disabled: disabled,
    id: idActual,
    type: type,
    onBlur: handleBlur,
    ...
    ref: inputRefActual,
    value: value
  }, customProps)), !noResize && Counter(hasCounter, currentMaxlength)), trailingIcon && !textarea && TrailingIcon(trailingIcon), suffixText && !trailingIcon && !textarea && /*#__PURE__*/React__default["default"].createElement("span", {
    className: "mdc-text-field__affix mdc-text-field__affix--suffix"
  }, suffixText), isOutlined && /*#__PURE__*/React__default["default"].createElement(reactNotchedOutline.NotchedOutline, null, hasLabel && /*#__PURE__*/React__default["default"].createElement(reactFloatingLabel.FloatingLabel, {
    id: labelIdActual,
    htmlFor: idActual
  }, label)), isFilled && hasLabel && /*#__PURE__*/React__default["default"].createElement(reactFloatingLabel.FloatingLabel, {
    id: labelIdActual,
    htmlFor: idActual
  }, label), (isFilled || isEmbedded) && /*#__PURE__*/React__default["default"].createElement(reactLineRipple.LineRipple, null)), trailingContent, hasHelperLine && /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    className: clsx__default["default"](['mdc-text-field-helper-text', helperTextPersistent && 'mdc-text-field-helper-text--persistent', helperTextValidation && 'mdc-text-field-helper-text--validation-msg'])
  }, helperText), noResize && Counter(hasCounter, currentMaxlength)), tooltip && /*#__PURE__*/React__default["default"].createElement(reactTooltip.TooltipText, _extends__default["default"]({
    role: "tooltip"
  }, tooltip, {
    ref: tooltipRef,
    text: value
...
exports.TextfieldSpanShim = TextfieldSpanShim;
