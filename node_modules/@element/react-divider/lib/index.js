...
const DividerPropTypes = {
   ...
   * Defaults to **undefined**.
   */
  dividerColor: reactCommon.deprecatedProp(PropTypes__default["default"].string, "Divider", "Use `themeColor` instead."),
  /**
   ...
   * Defaults to **undefined**.
   */
  dividerColorImportant: reactCommon.deprecatedProp(PropTypes__default["default"].bool, "Divider", "Use `themeColorImportant` instead."),
  /**
   ...
   * Defaults to **undefined**.
   */
  themeColorImportant: reactCommon.deprecatedProp(PropTypes__default["default"].bool, "Divider", "No longer needed."),
  /**
   * Choose between dense and tall variants.
   *
   * Defaults to **'dense'**.
   */
  variant: PropTypes__default["default"].oneOf(["dense", "tall"]),
  /**
   * Adds top and bottom margin.
   *
   * Defaults to **undefined**.
   */
  verticalMargin: PropTypes__default["default"].oneOf(["dense", "standard", "airy"])
};
...
const Divider = /*#__PURE__*/React.forwardRef((props, externalRef) => {
  const {
    dividerColor,
