...
const IconButtonPropTypes = {
   ...
   */
  variant: deprecatedOneOf(PropTypes.oneOf(["", "filled-danger-alt", "filled-danger", "filled-primary", "filled-secondary", "color-primary", "color-secondary", "color-on-dark"]), ["primary-alt", "secondary-alt", "primary", "danger-alt", "danger"], "IconButton", "Please use one of '','filled-danger-alt','filled-danger','filled-primary','filled-secondary','color-primary','color-secondary','color-on-dark'.")
};
...
const IconButton = /*#__PURE__*/forwardRef((props, externalRef) => {
  const {
    active,
    ariaLabel,
    ariaLabelledBy,
  ...
  return /*#__PURE__*/React.createElement("button", _extends({
    ...
    disabled: disabled,
    tabIndex: tabIndex
  }, customProps), icon && /*#__PURE__*/React.createElement(Icon, {
    badge: badge,
    badgePlacement: badgePlacement,
    icon: icon,
    iconSize: iconSize,
    iconType: iconType
  }), children && addProps(children, child => {
    var _child$props, _child$props2;
    return {
      className: clsx('mdc-icon-button__icon', child === null || child === void 0 ? void 0 : (_child$props = child.props) === null || _child$props === void 0 ? void 0 : _child$props.className),
  ...
  }), isToggleButton && addProps(toggleOn, child => {
    var _child$props3, _child$props4, _child$props5;
    return {
      className: clsx('mdc-icon-button__icon mdc-icon-button__icon--on', child === null || child === void 0 ? void 0 : (_child$props3 = child.props) === null || _child$props3 === void 0 ? void 0 : _child$props3.className),
  ...
  }), isToggleButton && addProps(toggleOff, child => {
    var _child$props6, _child$props7, _child$props8;
    return {
      className: clsx('mdc-icon-button__icon', child === null || child === void 0 ? void 0 : (_child$props6 = child.props) === null || _child$props6 === void 0 ? void 0 : _child$props6.className),
