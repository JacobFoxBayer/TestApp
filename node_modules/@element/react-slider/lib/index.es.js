...
import React, { forwardRef, useRef, useImperativeHandle, useCallback, useEffect, useMemo } from 'react';
...
const SliderPropTypes = {
   ...
   * Defaults to **'0'**.
   */
  minValue: PropTypes.oneOfType([PropTypes.number, PropTypes.string, PropTypes.object]),
  /**
...
const Slider = /*#__PURE__*/forwardRef((props, externalRef) => {
  ...
  const isMinInputValid = useCallback(val => {
    if (range) return val >= min && val <= value;
    return val >= min && val <= max;
  }, [min, value, max, range]);
  const isMaxInputValid = useCallback(val => {
  ...
  const minInputOnChange = useCallback(e => {
  ...
  const maxInputOnChange = useCallback(e => {
    const val = e.target.value;
  ...
  const leadingBlockToUse = useMemo(() => {
    ...
    switch (leadingBlockType) {
      case 'icon':
        return leadingBlock && typeof leadingBlock === 'string' ? /*#__PURE__*/React.createElement(Icon, _extends({
          icon: leadingBlock
        }, leadingBlockProps)) : leadingBlock;
      case 'input':
        if (leadingBlock) {
          return (range || trailingBlockType !== 'input') && addProps(leadingBlock, {
            min,
            max: maxInputValue,
            step,
            type: 'number',
        ...
        return (range || trailingBlockType !== 'input') && /*#__PURE__*/React.createElement(Textfield, _extends({
          variant: "outlined"
        }, leadingBlockProps, {
          dense: true,
          type: "number",
  ...
  const trailingBlockToUse = useMemo(() => {
    ...
    switch (trailingBlockType) {
      case 'icon':
        return trailingBlockType && typeof trailingBlock === 'string' ? /*#__PURE__*/React.createElement(Icon, {
          icon: trailingBlock
        }) : trailingBlock;
      case 'input':
        if (trailingBlock) {
          return trailingBlockType && addProps(trailingBlock, {
            min: minInputValue,
            max,
            step,
            type: 'number',
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: clsx('lmnt', 'lmnt-slider-container', disabled && 'lmnt-slider--disabled')
  }, showLeadingBlock && /*#__PURE__*/React.createElement("div", {
    className: clsx('lmnt-slider-info', 'lmnt-slider-info-leading', leadingBlockType === 'input' && 'lmnt-slider-info-with-input', themeColor === 'primary' && 'lmnt-slider-info--primary', themeColor === 'secondary' && 'lmnt-slider-info--secondary'),
    style: leadingBlockStyle
  }, leadingBlockToUse), /*#__PURE__*/React.createElement("div", {
    className: "lmnt lmnt-slider-inner"
  }, /*#__PURE__*/React.createElement("div", _extends({
    className: clsx('lmnt', 'mdc-slider', range && 'mdc-slider--range', discrete && 'mdc-slider--discrete', discrete && displayMarkers && 'mdc-slider--tick-marks', themeColor === 'primary' && 'mdc-slider--primary', themeColor === 'secondary' && 'mdc-slider--secondary', className),
    id: id,
    ref: ref
  }, customProps), range && /*#__PURE__*/React.createElement("input", {
  ...
  })), discrete && displayMarkers && /*#__PURE__*/React.createElement("div", {
    className: "mdc-slider__tick-marks"
  })), range && /*#__PURE__*/React.createElement("div", {
    className: "mdc-slider__thumb"
  }, discrete && /*#__PURE__*/React.createElement("div", {
  ...
  }, (_mdcSlider$current10 = mdcSlider.current) === null || _mdcSlider$current10 === void 0 ? void 0 : _mdcSlider$current10.getValueStart()))), /*#__PURE__*/React.createElement("div", {
    ...
    className: "mdc-slider__value-indicator-text"
  }, (_mdcSlider$current11 = mdcSlider.current) === null || _mdcSlider$current11 === void 0 ? void 0 : _mdcSlider$current11.getValue()))), /*#__PURE__*/React.createElement("div", {
    className: "mdc-slider__thumb-knob"
  })))), showTrailingBlock && /*#__PURE__*/React.createElement("div", {
    className: clsx('lmnt-slider-info', 'lmnt-slider-info-trailing', trailingBlockType === 'input' && 'lmnt-slider-info-with-input', themeColor === 'primary' && 'lmnt-slider-info--primary', themeColor === 'secondary' && 'lmnt-slider-info--secondary'),
