...
$secondaryMap: (
    secondary-50: #fdf7e8,
    secondary-100: #f9e7ba,
    secondary-200: #f5d78c,
    secondary-300: #f2c85f,
    secondary-400: #eeb831,
    secondary-500: #eba904,
    secondary-600: #d69a04,
    secondary-700: #c18b04,
    secondary-800: #563e02,
    secondary-900: #161001
);
...
$ancillaryMap: (
    ancillary-100: #3ab7a2,
    ancillary-200: #f6a649,
    ancillary-300: #f886e0
);
...
$OpenSans: "'Open Sans', Arial, 'Helvetica Neue', Helvetica, sans-serif";
...
.lmnt-theme-lewishybrids {
    --lmnt-theme-primary-font: #{$OpenSans};
...
.lmnt-theme-lewishybrids {
    ...
    --lmnt-theme-primary-font: #{$OpenSans};
    --lmnt-theme-secondary-font: #{$OpenSans};
...
// Open Sans - regular, regular italic, bold, bold italic
@font-face {
    font-display: swap;
    font-family: 'Open Sans';
    font-style: normal;
    font-weight: 400;
    src: url('#{$assetsPath}/assets/fonts/Open_Sans/OpenSans-Regular.ttf')
        format('truetype');
}
...
@font-face {
    ...
    font-style: italic;
    font-weight: 400;
    src: url('#{$assetsPath}/assets/fonts/Open_Sans/OpenSans-Italic.ttf')
        format('truetype');
}
...
@font-face {
    ...
    font-style: normal;
    font-weight: 700;
    src: url('#{$assetsPath}/assets/fonts/Open_Sans/OpenSans-Bold.ttf') format('truetype');
}
...
@font-face {
    ...
    font-style: italic;
    font-weight: 700;
    src: url('#{$assetsPath}/assets/fonts/Open_Sans/OpenSans-BoldItalic.ttf')
        format('truetype');
}
