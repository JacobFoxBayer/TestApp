...
$lmnt-theme-success: #01c059;
$lmnt-theme-success-variant: #007536;
...
$dataVizSequential2Map: (
    dataVizSequential2-50: #012b16,
    dataVizSequential2-100: #004422,
    dataVizSequential2-200: #2b6636,
    dataVizSequential2-300: #108000,
    dataVizSequential2-400: #66b512,
    dataVizSequential2-500: #89d329,
    dataVizSequential2-600: #a2df52,
    dataVizSequential2-700: #cbf594,
    dataVizSequential2-800: #d8f8ab,
    dataVizSequential2-900: #e9f9d4
);

$ancillaryMap: (
    ancillary-100: #d30f4b,
    ancillary-200: #624963,
    ancillary-300: #443247
);
...
$onClassesMap: map.merge(
    ...
    (
        on-primary: #10384f,
        on-secondary: #10384f,
        on-background: #10384f,
        on-surface: #10384f,
        primary-on-surface: #41852c,
        secondary-on-surface: #10384f,
        danger-on-surface: #ffffff,
        success-on-surface: #10384f
    )
);
...
.lmnt-theme-bayerplusrewards {
    ...
    --lmnt-theme-on-primary: #{map.get($onClassesMap, 'on-secondary')};
    ...
    --lmnt-theme-danger-on-surface: #{$lmnt-theme-danger};
    ...
    --mdc-typography-headline2-letter-spacing: 0.020833em; // 0.5px

    // Display 6
    --mdc-typography-headline6-font-weight: 500;
    --mdc-typography-headline6-letter-spacing: 0.007352941176470588em; // 0.25
