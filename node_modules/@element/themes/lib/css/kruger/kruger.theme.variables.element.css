...
.lmnt-theme--bg-linear-gradient-primary-to-bottom {
  background: linear-gradient(180deg, rgba(0, 0, 0, 0) 0, rgba(0, 122, 51, 0.8) 100%);
  color: white;
}

.lmnt-theme--bg-linear-gradient-primary-dark-to-bottom {
  background: linear-gradient(180deg, rgba(0, 0, 0, 0) 0, rgba(13, 59, 3, 0.8) 100%);
  color: white;
}

.lmnt-theme--bg-linear-gradient-primary-darker-to-bottom {
  background: linear-gradient(180deg, rgba(0, 0, 0, 0) 0, rgba(2, 10, 1, 0.8) 100%);
  color: white;
}

.lmnt-theme--bg-linear-gradient-secondary-to-bottom {
  background: linear-gradient(180deg, rgba(0, 0, 0, 0) 0, rgba(255, 215, 0, 0.8) 100%);
  color: rgba(0, 0, 0, 0.87);
}

.lmnt-theme--bg-linear-gradient-secondary-dark-to-bottom {
  background: linear-gradient(180deg, rgba(0, 0, 0, 0) 0, rgba(208, 73, 11, 0.8) 100%);
  color: white;
}

.lmnt-theme--bg-linear-gradient-secondary-darker-to-bottom {
  background: linear-gradient(180deg, rgba(0, 0, 0, 0) 0, rgba(160, 56, 8, 0.8) 100%);
  color: white;
}

.lmnt-theme--bg-linear-gradient-primary-to-top {
  background: linear-gradient(0deg, rgba(0, 0, 0, 0) 0, rgba(0, 122, 51, 0.8) 100%);
  color: white;
}

.lmnt-theme--bg-linear-gradient-primary-dark-to-top {
  background: linear-gradient(0deg, rgba(0, 0, 0, 0) 0, rgba(13, 59, 3, 0.8) 100%);
  color: white;
}

.lmnt-theme--bg-linear-gradient-primary-darker-to-top {
  background: linear-gradient(0deg, rgba(0, 0, 0, 0) 0, rgba(2, 10, 1, 0.8) 100%);
  color: white;
}

.lmnt-theme--bg-linear-gradient-secondary-to-top {
  background: linear-gradient(0deg, rgba(0, 0, 0, 0) 0, rgba(255, 215, 0, 0.8) 100%);
  color: rgba(0, 0, 0, 0.87);
}

.lmnt-theme--bg-linear-gradient-secondary-dark-to-top {
  background: linear-gradient(0deg, rgba(0, 0, 0, 0) 0, rgba(208, 73, 11, 0.8) 100%);
  color: white;
}

.lmnt-theme--bg-linear-gradient-secondary-darker-to-top {
  background: linear-gradient(0deg, rgba(0, 0, 0, 0) 0, rgba(160, 56, 8, 0.8) 100%);
  color: white;
}
...
.lmnt,
.lmnt-theme-kruger {
  --lmnt-theme-primary-font: 'Lato', Calibri, Lucida Grande, Arial, sans-serif;
}

.lmnt,
.lmnt-theme-kruger {
  --lmnt-theme-primary-font: 'Lato', Calibri, Lucida Grande, Arial, sans-serif;
  --lmnt-theme-secondary-font: 'Nunito Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif;
  --lmnt-theme-primary: #007a33;
  --lmnt-theme-primary-variant: #025b0d;
  --lmnt-theme-primary-on-surface: #007a33;
  --lmnt-primary-on-surface-rgb: 0, 122, 51;
  --lmnt-theme-secondary: #ffd700;
  --lmnt-theme-secondary-variant: #e87722;
  --lmnt-theme-secondary-on-surface: #d0490b;
  --lmnt-primary-on-surface-rgb: 0, 122, 51;
  --lmnt-secondary-on-surface-rgb: 208, 73, 11;
  --lmnt-danger-on-surface-rgb: 207, 45, 34;
  --lmnt-success-on-surface-rgb: 207, 45, 34;
  --lmnt-on-primary-rgb: 255, 255, 255;
  --lmnt-on-secondary-rgb: 0, 0, 0;
  ...
  --lmnt-on-success-rgb: 255, 255, 255;
  --lmnt-theme-primary-50: #d9e33e;
  --lmnt-theme-primary-100: #bbde2f;
  --lmnt-theme-primary-200: #97d700;
  --lmnt-theme-primary-300: #6ecc17;
  --lmnt-theme-primary-400: #41bf0e;
  --lmnt-theme-primary-500: #14ac08;
  --lmnt-theme-primary-600: #03961b;
  --lmnt-theme-primary-700: #007a33;
  --lmnt-theme-primary-800: #025b0d;
  --lmnt-theme-primary-900: #0d3b03;
  --lmnt-theme-secondary-50: #ffebae;
  --lmnt-theme-secondary-100: #ffe16e;
  --lmnt-theme-secondary-200: #fedb34;
  --lmnt-theme-secondary-300: #ffd700;
  --lmnt-theme-secondary-400: #f9c300;
  --lmnt-theme-secondary-500: #f5ac00;
  --lmnt-theme-secondary-600: #ef9200;
  --lmnt-theme-secondary-700: #e87722;
  --lmnt-theme-secondary-800: #e25e01;
  --lmnt-theme-secondary-900: #d0490b;
  --lmnt-theme-success-50: #eeffef;
  --lmnt-theme-success-100: #d3ffd7;
  --lmnt-theme-success-200: #a9f6af;
  --lmnt-theme-success-300: #6fef7a;
  ...
  --lmnt-theme-danger-800: #c2261b;
  --lmnt-theme-danger-900: #b3190d;
  --lmnt-theme-ancillary-100: #97d700;
  --lmnt-theme-ancillary-200: #d9e33e;
  --lmnt-theme-ancillary-300: #ffe16e;
  --lmnt-button-shape-radius: 0;
  --lmnt-theme-on-snackbar: #97d700;
  --lmnt-theme-on-snackbar-variant: #ffe16e;
  --lmnt-typography-link-color: #03961b;
  --mdc-typography-headline1-font-family: var(lmnt-theme-secondary-font);
  --mdc-typography-headline1-font-weight: 600;
  --mdc-typography-headline1-letter-spacing: -0.016em;
  --mdc-typography-headline1-line-height: 1.2803333;
  ...
  --mdc-typography-body2-line-height: 1.42857;
  --mdc-typography-caption-line-height: 1.3333333;
  --mdc-typography-button-font-weight: 700;
  --mdc-typography-button-letter-spacing: 0.054em;
  --mdc-typography-button-line-height: 1.1428571;
  --mdc-typography-overline-font-weight: 400;
  --mdc-typography-overline-line-height: 1.333333333;
}
...
@font-face {
  ...
  font-style: italic;
  font-weight: 400;
  src: url(0b4ed00316a7940bfc3f43655567264c.ttf) format("truetype");
}
@font-face {
  font-display: swap;
  font-family: "Lato";
...
@font-face {
  ...
  font-style: italic;
  font-weight: 700;
  src: url(4113fd37d3dbdde7157064b09d4fd674.ttf) format("truetype");
}
@font-face {
  font-display: swap;
  ...
  font-style: normal;
  font-weight: 600;
  src: url(662b866576cfea51dd641d058b988bbd.ttf) format("truetype");
}
@font-face {
  font-display: swap;
  font-family: "Nunito Sans";
  font-style: italic;
  font-weight: 600;
  src: url(ccfebb169c066078a97869a1215d9241.ttf) format("truetype");
}
/* stylelint-enable scale-unlimited/declaration-strict-value, font-weight-notation, indentation, font-family-name-quotes */

/*# sourceMappingURL=kruger.theme.variables.element.css.map*/