...
var menuSurface = require('@material/menu-surface');
...
const MenuPropTypes = {
   ...
   * Defaults to **null**.
   */
  absolutePositionX: PropTypes__default["default"].number,
  /**
   ...
   * Defaults to **null**.
   */
  absolutePositionY: PropTypes__default["default"].number,
  /**
   ...
   */
  anchorCorner: PropTypes__default["default"].oneOf(["TOP_LEFT", "TOP_RIGHT", "BOTTOM_LEFT", "BOTTOM_RIGHT", "TOP_START", "TOP_END", "BOTTOM_START", "BOTTOM_END"]),
  /**
   ...
   * Defaults to **null**.
   */
  anchorMargin: PropTypes__default["default"].object,
  /**
   * Custom props to be sent to the MenuAnchor wrapper of the `trigger`
   *
   * Defaults to **{}**.
   */
  anchorProps: PropTypes__default["default"].object,
  /**
   ...
   * Defaults to **'ltr'**.
   */
  direction: PropTypes__default["default"].oneOf(["ltr", "rtl"]),
  /**
   ...
   * Defaults to **null**.
   */
  handleBodyClick: PropTypes__default["default"].func,
  /**
   ...
   * Defaults to **false**.
   */
  hoistToBody: PropTypes__default["default"].bool,
  /**
   ...
   * Defaults to **false**.
   */
  surfaceOnly: PropTypes__default["default"].bool,
  /**
   ...
   * Defaults to **null**.
   */
  trigger: PropTypes__default["default"].node,
  /**
...
const MenuAnchor = /*#__PURE__*/React.forwardRef((props, ref) => {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", _extends__default["default"]({
    ref: ref,
    className: clsx__default["default"]('lmnt', 'mdc-menu-surface--anchor', className)
...
const triggerWrapper = (anchorProps, trigger, anchorRef) => children => /*#__PURE__*/React__default["default"].createElement(MenuAnchor, _extends__default["default"]({}, anchorProps, {
  ref: anchorRef
}), trigger, children);
const portalWrapper = hoistToBody => children => /*#__PURE__*/React__default["default"].createElement(reactPortal.Portal, {
  disabled: !hoistToBody
}, children);
const Menu = /*#__PURE__*/React.forwardRef((props, externalRef) => {
  const {
    absolutePositionX,
    absolutePositionY,
    anchorCorner,
  ...
  const [openUp, setOpenUp] = React.useState();
  const ref = React.useRef();
  const mdcMenu = React.useRef();
  const anchorRef = React.useRef();
  React.useImperativeHandle(externalRef, () => ref.current, []);
  const handleOnOpen = React.useCallback(e => {
    ...
    const verticalAlignment = surfaceOnly && mdcMenu.current.foundation.hasBit(corner, menuSurface.CornerBit.BOTTOM) || !surfaceOnly && mdcMenu.current.menuSurface_.foundation.hasBit(corner, menuSurface.CornerBit.BOTTOM) ? 'bottom' : 'top';
  ...
  React.useEffect(() => {
    mdcMenu.current = surfaceOnly ? menuSurface.MDCMenuSurface.attachTo(ref.current) : menu.MDCMenu.attachTo(ref.current);
    return () => {
  ...
  React.useEffect(() => {
    if (anchorCorner && !(absolutePositionX || absolutePositionY)) {
      mdcMenu.current.setAnchorCorner(menu.Corner[anchorCorner.toUpperCase()]);
    }
  ...
  const classes = React.useMemo(() => {
    ...
    return clsx__default["default"]('lmnt', 'mdc-menu-surface', 'lmnt-menu-container', (surfaceOnly && ((_mdcMenu$current = mdcMenu.current) === null || _mdcMenu$current === void 0 ? void 0 : _mdcMenu$current.foundation.isOpen()) || !surfaceOnly && ((_mdcMenu$current2 = mdcMenu.current) === null || _mdcMenu$current2 === void 0 ? void 0 : _mdcMenu$current2.menuSurface_.foundation.isOpen())) && 'mdc-menu-surface--open', openUp && 'lmnt-menu-open-up', !surfaceOnly && 'mdc-menu', !hoistToBody && fullWidth && 'mdc-menu-surface--fullwidth', hoistToBody && fullScreen && 'lmnt-menu-surface--fullScreen', `lmnt-theme-${themeColor}-bg`, className);
  }, [className, fullScreen, fullWidth, hoistToBody, openUp, surfaceOnly, themeColor]);
  const createTriggerWrapper = React.useMemo(() => triggerWrapper(anchorProps, trigger, anchorRef), [anchorProps, trigger]);
  const createPortalWrapper = React.useMemo(() => portalWrapper(hoistToBody), [hoistToBody]);
  ...
  return /*#__PURE__*/React__default["default"].createElement(reactCommon.ConditionalWrapper, {
    ...
    className: classes,
    tabIndex: "-1"
  }, customProps), /*#__PURE__*/React__default["default"].createElement(MenuContext.Provider, {
    value: value
  }, children))));
});
