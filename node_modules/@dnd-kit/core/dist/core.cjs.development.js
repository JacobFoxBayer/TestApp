...
function useAutoScroller(_ref) {
  var acceleration = _ref.acceleration,
      ...
      activator = _ref$activator === void 0 ? exports.AutoScrollActivator.Pointer : _ref$activator,
      ...
      order = _ref$order === void 0 ? exports.TraversalOrder.TreeOrder : _ref$order,
  ...
  var sortedScrollableAncestors = React.useMemo(function () {
    return order === exports.TraversalOrder.TreeOrder ? [].concat(scrollableAncestors).reverse() : scrollableAncestors;
...
function useLayoutMeasuring(containers, _ref) {
  ...
  var recomputeLayoutsTimeoutId = React.useRef(null);
...
var DndContext = /*#__PURE__*/React.memo(function DndContext(_ref) {
  ...
  var pointerCoordinates = activationCoordinates ? utilities.add(activationCoordinates, translate) : null;
...
function useDraggable(_ref) {
  ...
  [draggableNodes, id]);
  var memoizedAttributes = React.useMemo(function () {
    return {
      role: role,
      tabIndex: tabIndex,
