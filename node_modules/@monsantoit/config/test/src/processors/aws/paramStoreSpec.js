...
describe('paramStore', () => {
    ...
    let ssmSendPromiseStub

    beforeEach(() => {
        ssmSendPromiseStub = sandbox.stub()
        ssmSendPromiseStub.resolves({
            Parameters: [
        ...
        sandbox.stub(SSMClient.prototype, 'send').value(ssmSendPromiseStub)
    })
    afterEach(() => {
        sandbox.restore()
    })
            ...
            Parameters: [
                {
                    ...
                    ARN: 'arn:aws:ssm:us-east-1:accountnumber:parameter/foo/feedback/buzzbar/Buzzbar'
                }
            ],
        ...
        ssmSendPromiseStub.resolves({
            Parameters: [
                ...
                },
                {
                    ...
                    ARN: 'arn:aws:ssm:us-east-1:accountnumber:parameter/some-team/aws/admin/accessKeyId'
                },
                {
                    ...
                    ARN: 'arn:aws:ssm:us-east-1:accountnumber:parameter/some-team/aws/admin/barAccessKey'
                },
                {
                    Name: '/some-team/banana/apple',
                    Type: 'String',
                    Value: 'https://search-some-team-logs-np-pbxatmzszhbnhqbk6t3v7kl46m.us-east-1.es.amazonaws.com',
                    Version: 1,
