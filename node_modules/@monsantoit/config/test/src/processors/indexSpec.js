...
describe('processors', () => {
    ...
    beforeEach(() => {
        ...
        process.env.STRING_VARIABLE_FOR_TESTING = 'This is a string.'
        process.env.JSON_VARIABLE_FOR_TESTING = '{"bar":{"baz":"value"}}'
    ...
    describe('readVaultFromConfig', () => {
        ...
        it('returns a new config with paths to whole objects', async () => {
            const params = {
                enabled: true,
                url: {value: 'https://vault.agro.services'},
                auth: {
        ...
        it('returns a new config using kv paths to whole objects', async () => {
            const params = {
                enabled: true,
                url: {value: 'https://vault.agro.services'},
                auth: {
    ...
    describe('readEnvironmentVariablesFromConfig', () => {
        const config = {
            testA: 'env://STRING_VARIABLE_FOR_TESTING',
            testB: 'env://JSON_VARIABLE_FOR_TESTING/bar/baz',
            testC: 'env://JSON_VARIABLE_FOR_TESTING/bar',
            testD: 'env://JSON_VARIABLE_FOR_TESTING/',
            nonParam: 'something else'
        }

        it('returns a new config with environment variable values resolved', async () => {
            const data = await processors.readEnvironmentVariablesFromConfig({enabled: true})(
                config
            )

            data.should.eql({
                testA: 'This is a string.',
                testB: 'value',
                testC: {baz: 'value'},
                testD: {bar: {baz: 'value'}},
                nonParam: 'something else'
        ...
        it('does nothing if enabled is false', async () => {
            const data = await processors.readEnvironmentVariablesFromConfig({enabled: false})(
                config
            )
            data.should.eql(config)
        })
