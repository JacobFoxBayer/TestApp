...
.navigation .headers-popup h3 {
  text-align: center;
  margin-top: 0;
}
.navigation .headers-popup input {
  width: 50%;
  font-size: 115%;
  margin-bottom: 14px;
  color: black;
...
.navigation .headers-popup input.key {
  border-radius: 5px 0 0 5px;
  border-right: none;
}
.navigation .headers-popup input.value {
  border-radius: 0 5px 5px 0;
}
.navigation .headers-popup .buttons {
  text-align: center;
}
.navigation .headers-popup .buttons button {
  margin-right: 5px;
}
.markdown {
  margin-top: 50px;
}
.markdown .graphql-code {
  height: 500px;
...
.api .field .description p {
  margin-bottom: 0;
}
.api .field .field-type-name {
  color: grey;
}
.api .field a .field-type-name {
  color: inherit;
}
.api .enum {
  margin-bottom: 15px;
...
.api .enum .description p {
  margin-bottom: 0;
}
.graphql-voyager .type-info-popover,
.graphql-voyager .doc-navigation {
  box-shadow: none;
  -webkit-box-shadow: none;
}
...
.graphql-voyager > .doc-panel > .contents {
  background: white;
  box-shadow: none;
  -webkit-box-shadow: none;
...
.explorer-page .graphiql-container {
  position: fixed;
  top: 50px;
  bottom: 0;
  left: 0;
...
.explorer-page .graphiql-container .topBar {
  background: white;
  height: 51px;
}
.graphiql-container .doc-explorer {
...
.graphiql-container .history-contents > p > span:first-child {
  width: 190px;
  display: inline-block;
  overflow: hidden;
  text-overflow: ellipsis;
